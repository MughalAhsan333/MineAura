...
export default function MinerShop() {
  ...
  // This would run when component mounts
  // For now, we'll use a button to load miners
        ...
        {miners.map((miner) => (
          <div key={miner.id} className="border rounded-lg p-4">
            ...
            <button
              ...
              className="bg-green-500 hover:bg-green-600 text-white mt-2 px-4 py-2 rounded w-full"
            >
              Buy Now
            </button>
          </div>
